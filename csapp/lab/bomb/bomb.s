...
00000000004010f4 <phase_6>:
  ...
  40117f:	75 f5                	jne    401176 <phase_6+0x82>    eax != ecx ? goto 401176
  401181:	eb 05                	jmp    401188 <phase_6+0x94>    goto 401188
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx           edx = 0x14c
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)   M[rsp + 2 * rsi + 0x20] = rdx
  40118d:	48 83 c6 04          	add    $0x4,%rsi                rsi += 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi               rsi : 0x18
  401195:	74 14                	je     4011ab <phase_6+0xb7>    rsi == 0x18 ? goto 4011ab 
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx       ecx = rsp + rsi
  40119a:	83 f9 01             	cmp    $0x1,%ecx                ecx : 1
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>    ecx <= 1 ? goto 401183
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                eax = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx           edx = 0x14c
  ...
  4011c8:	48 39 f0             	cmp    %rsi,%rax                rsi : rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>    rsi == rax ? goto 4011d2
  4011cd:	48 89 d1             	mov    %rdx,%rcx                rcx = rdx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>    goto 4011bd
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)           M[rdx + 0x8] = 0
  4011d9:	00 
  ...
  4011e5:	39 03                	cmp    %eax,(%rbx)              M[rbx] : eax
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>    M[rbx] >= eax ? goto 4011ee
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx           rbx = rbx + 8
  4011f2:	83 ed 01             	sub    $0x1,%ebp                ebp -= 1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>    ebp != 0 ? goto 4011df
  4011f7:	48 83 c4 50          	add    $0x50,%rsp               rsp += 50
  4011fb:	5b                   	pop    %rbx
  4011fc:	5d                   	pop    %rbp
